...
class Curl
{
    ...
    {
        $this->jsonDecoder = '\MoneyGo\Curl\Decoder::decodeJson';
    ...
    {
        $this->xmlDecoder = '\MoneyGo\Curl\Decoder::decodeXml';
    ...
    public function setDefaultDecoder($mixed = 'json')
    {
        if ($mixed === false) {
            ...
            if ($mixed === 'json') {
                $this->defaultDecoder = '\MoneyGo\Curl\Decoder::decodeJson';
            } elseif ($mixed === 'xml') {
                $this->defaultDecoder = '\MoneyGo\Curl\Decoder::decodeXml';
            }
        }
    }
